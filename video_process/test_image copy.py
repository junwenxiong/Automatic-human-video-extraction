...
image_list = sorted(
    [
        *glob.glob(os.path.join(args.images_dir, "**", "*.jpg"), recursive=True),
...
if args.gt_dir is not None:
    gt_list = sorted(
        [
            *glob.glob(os.path.join(args.gt_dir, "**", "*.jpg"), recursive=True),
...
for i in range(num_image):
    ...
    # save results
    output_dir = (
        args.result_dir + image_path[len(args.images_dir) : image_path.rfind("/")]
    )
